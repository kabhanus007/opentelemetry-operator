module github.com/open-telemetry/opentelemetry-operator/internal/experimental
...
//replace github.com/open-telemetry/opentelemetry-operator/internal/experimental => ../../
